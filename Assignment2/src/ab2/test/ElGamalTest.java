...
import ab2.impl.Eberl.ElGamalImpl;
...
public class ElGamalTest {
    ...
    public void testInit_2() {
        ...
        for (int i = 0; i < TESTCOUNT_INIT; i++) {
            ...
            // g^q mod p muss entweder -1 oder 1 sein (beides ist ok)
            BigInteger res = g.modPow(BigInteger.valueOf(factors.get(1)), p);
            assertNotEquals(BigInteger.ONE, res.abs());
